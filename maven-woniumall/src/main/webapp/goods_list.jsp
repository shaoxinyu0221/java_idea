...
<body>
				...
				<tbody id="tbd">
					<c:forEach var="goods" items="${goodsInfo.list}" varStatus="vs">
						<tr class="text-center">
							...
							<td>
								<a href="paper_update.jsp"><span class="glyphicon glyphicon-pencil"></span>修改</a>&nbsp;&nbsp;&nbsp;
								<a href=""><span class="glyphicon glyphicon-download-alt"></span>下架</a>
							</td>
						</tr>
					</c:forEach>
	...
	<script>
		...
		function changePageNum() {
			...
			window.location.href = "${pageContext.request.contextPath}/manage/goods?opr=queryGoodsList&pageNum="+pageNumber
		}

		function changePage(pageNumber){
			let goodName = document.getElementById("goodName").value;
			let goodTypeId = document.getElementById("goodTypeId").value;
			window.location.href = "${pageContext.request.contextPath}/manage/goods?opr=queryGoodsList&pageNum="+pageNumber+"&goodName="+goodName+"&goodTypeId="+goodTypeId
		}
